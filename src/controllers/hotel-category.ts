...
// import { AddHotelCategoryBody, UpdateHotelCategoryBody } from '../types/hotel-category.types';

// const HOTEL_CATEGORY = new Utils(ENTITES.HOTEL_CATEGORY);
...
//   if (hotelCategory) return next(HOTEL_CATEGORY.DUPLICATION('name'));
